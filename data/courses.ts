    ...
    days: [
      {
        ...
        topics: [
          ...
          "Memory, tools, and decision loops",
          "Human-in-the-loop systems",
          "Designing workflows that augment humans",
          "Where agents help — and where they shouldn't be trusted",
        ],
        learningObjectives: [
          "Understand agentic AI architecture and reasoning",
          "Learn to design human-augmenting workflows",
          "Build systems that keep humans in control",
        ],
      },
      {
        id: "saturday-2",
